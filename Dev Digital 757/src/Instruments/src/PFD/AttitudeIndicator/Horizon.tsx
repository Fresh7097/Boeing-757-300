    ...
    return (
        <g>
            ...
            <g transform={`rotate(${roll || 0} ${AH_CENTER_X} ${AH_CENTER_Y}) translate(0 -18) translate(0 ${pitchToGraduationPixels(-pitch) || 0})`}>
                {/* AH top */}
                <rect x={0} y={-800}  width={800} height={1200} fill="#1469BC" stroke="black" stroke-width="-20"/>

                {/* AH bottom*/}
                <rect x={0} y={400} width={800} height={900} fill="#764D17" stroke="black" stroke-width="-20"/>
            ...
            <g transform={`rotate(${roll || 0} ${AH_CENTER_X} ${AH_CENTER_Y})`}>
                ...
                <g transform={`translate(${sideslipAngleToDisplacment(sideslip) || 0} 0)`}>
                    <path fill="none" stroke="black" strokeWidth="4" d="M333 214, h32, v 6, h-32, Z" stroke-linejoin="square" />
                    <path
                ...
                {/* Bank Pointer */}
                <path fill="none" stroke="black" strokeWidth="4" d="M349 194, l-16 20, h32, Z" stroke-linejoin="square" />
                <path
